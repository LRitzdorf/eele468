-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/fftAnalysisSynthesis/fastTransition.vhd
-- 
...
ARCHITECTURE rtl OF fastTransition IS
  ...
  SIGNAL passthroughSlow_1                : std_logic;  -- ufix1
  SIGNAL filterSelectSlow_unsigned        : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL filterSelectSlow_1               : unsigned(1 DOWNTO 0);  -- ufix2
...
BEGIN
  ...
  passthroughFast <= passthroughSlow_1;
