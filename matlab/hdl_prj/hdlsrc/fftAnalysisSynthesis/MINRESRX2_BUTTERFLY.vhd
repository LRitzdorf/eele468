-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/fftAnalysisSynthesis/MINRESRX2_BUTTERFLY.vhd
-- 
...
-- Source Path: fftAnalysisSynthesis/fftAnalysisSynthesis/analysis/FFT/MINRESRX2_BUTTERFLY
-- Hierarchy Level: 3
-- Model version: 8.3
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF MINRESRX2_BUTTERFLY IS
  ...
  SIGNAL intdelay_reg_4                   : std_logic_vector(7 DOWNTO 0);  -- ufix1 [8]
