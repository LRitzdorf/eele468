...
-- enb_1_2048_7: 2048x slower than clk with phase 7
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF fftAnalysisSynthesis_tc IS
  ...
  SIGNAL comp_7_tmp                       : std_logic;
  SIGNAL phase_7_tmp                      : std_logic;
  SIGNAL phase_7                          : std_logic;
  SIGNAL enb_1_2048_7_1                   : std_logic;
...
BEGIN
  ...
  comp_7_tmp <= '1' WHEN count2048 = to_unsigned(16#006#, 11) ELSE
      '0';

  phase_7_tmp <= comp_7_tmp AND clk_enable;
  ...
  enb_1_2048_7_1 <= phase_7 AND clk_enable;

  enb_1_2048_7 <= enb_1_2048_7_1;
