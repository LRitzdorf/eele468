-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/fftAnalysisSynthesis/TWDLROM.vhd
-- 
...
-- 
-- Module: TWDLROM
-- Source Path: fftAnalysisSynthesis/fftAnalysisSynthesis/analysis/FFT/TWDLROM
-- Hierarchy Level: 3
-- Model version: 8.3
-- 
-- -------------------------------------------------------------
...
BEGIN
  ...
  BEGIN
    ...
    IF ( NOT initIC) = '1' THEN 
      IF dMemOutDly_vld = '1' AND (minResRX2FFTTwdlMapping_cnt = to_unsigned(16#00#, 6)) THEN 
