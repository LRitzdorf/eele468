-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/fftAnalysisSynthesis/MINRESRX2FFT_CTRL_block.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: MINRESRX2FFT_CTRL_block
-- Source Path: fftAnalysisSynthesis/fftAnalysisSynthesis/synthesis/iFFT/MINRESRX2FFT_CTRL
-- Hierarchy Level: 3
-- Model version: 8.3
-- 
-- -------------------------------------------------------------
...
ENTITY MINRESRX2FFT_CTRL_block IS
...
END MINRESRX2FFT_CTRL_block;


ARCHITECTURE rtl OF MINRESRX2FFT_CTRL_block IS
...
BEGIN
  ...
  minResRX2FFTCtrl_output : PROCESS (din_1_im_signed, din_1_re_signed, minResRX2FFTCtrl_activeMem,
       ...
       stgOut2_im_signed, stgOut2_re_signed, stgOut_vld, syncReset, validIn)
  ...
  BEGIN
    ...
    stageLSB := minResRX2FFTCtrl_stageReg(0);
    IF ( NOT syncReset) = '1' THEN 
      CASE minResRX2FFTCtrl_state IS
        ...
        WHEN "0010" =>
          ...
          END IF;
          vldOut_Reg := minResRX2FFTCtrl_rdEnb2_Reg OR minResRX2FFTCtrl_rdEnb3_Reg;
